...
const events = [
  ...
  {
    time: '11.04 AM',
    title: 'Poruwa Ceremony & Engagement Function',
    description: 'Poruwa Ceremony commences at 11.04 am, followed by the engagement function at Senuri Grand Castello, Divulapitiya.',
    icon: MapPin,
